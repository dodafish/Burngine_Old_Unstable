...
public:
	DistortionConfig(	float k0 = 1.0f,
						float k1 = 0.0f,
						float k2 = 0.0f,
						float k3 = 0.0f) :
	XCenterOffset(0),
	...
	void SetChromaticAberration(float red1 = 1.0f,
								float red2 = 0.0f,
								float blue1 = 1.0f,
								float blue2 = 0.0f) {
...
public:
	...
	void SetDistortionFitPointVP(	float x,
									float y);
	...
	void SetDistortionFitPointPixels(	float x,
										float y);
	...
	float GetYFOVDegrees() {
		return RadToDegree(GetYFOVRadians());
	}
