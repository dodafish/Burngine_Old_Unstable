...
#ifndef VARIANCESHADOWCUBEMAP_H_
#define VARIANCESHADOWCUBEMAP_H_
 ...
 */
class BURNGINE_API VarianceShadowCubeMap : public BaseTexture {
public:
	/**
	 * @brief Constructor initializing some values
	 */
	VarianceShadowCubeMap();

	//Rendertargets are not copyable!
	VarianceShadowCubeMap(const VarianceShadowCubeMap& other) = delete;
	VarianceShadowCubeMap& operator=(const VarianceShadowCubeMap& other) = delete;
...
private:
	...
	GLuint _framebuffer, _cubeMap, _depthbuffer;
...
#endif /* VARIANCESHADOWCUBEMAP_H_ */
